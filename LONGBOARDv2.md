# BMC64 PCB (Longboard v2)

This Longboard v2 README details how to build or [modify](MODIFICATIONS.md) the v 2.0.5 of the BMC64 PCB. The longboard is effectively **DEPRECATED** for now, and won't get any more updates. Go [here](README.md) for the latest shortboard or [here](LONGBOARD.md) for the latest longboard.
...
The [Longboard v4](LONGBOARD.md) is BACK!!! 😃 If you are interested in the longboard form factor go directly to it's [README](LONGBOARD.md).

---

- [BMC64 PCB (Longboard v2)](#bmc64-pcb-longboard-v2)
...
Full [BOM (Longboard)](bom/longboard-bom-v2.md) of parts needed.
